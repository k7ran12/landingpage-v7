            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Update Pagina</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec1_logo"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec1_logo }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec1_logo.'') }}" width="300px">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec1_bannerimagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec1_bannerimagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec1_bannerimagen.'') }}" height="200" width="300px">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec2_card1_imagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec2_card1_imagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec2_card1_imagen.'') }}" height="200" width="300px">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec2_card2_imagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec2_card2_imagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec2_card2_imagen.'') }}" height="200" width="300px">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec2_card3_imagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec2_card3_imagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec2_card3_imagen.'') }}" height="200" width="300px">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec4_card1_imagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec4_card1_imagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec4_card1_imagen.'') }}" width="300px">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec4_card2_imagen.'') }}" width="300px">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec5_card1_imagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec5_card1_imagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec5_card1_imagen.'') }}" width="120px">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        />
                        <input
                            name="hidden_sec5_card2_imagen"
                            class="form-control"
                            type="hidden"
                            value="{{ $pagina->sec5_card2_imagen }}"
                        />
                        <img src="{{ asset('images/paginas/'.$pagina->sec5_card2_imagen.'') }}" width="120px">
